            ...
            <tbody>
                ...
                <tr class="text-c">
					...
					<td class="td-manage">
                        ...
                        <a title="回收站" href="javascript:;" onclick="del(this,'/admin/user/del','{{$item->id}}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont" style="font-size:16px;">&#xe631;</i></a>
					</td>
                </tr>
                @endforeach
            </tbody>
