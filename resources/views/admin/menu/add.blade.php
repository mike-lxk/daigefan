...
<div class="page-container">
	...
	<div class="row cl" style="margin-bottom:15px;margin-right:25px;">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			<input type="text" name="name" value="" class="input-text" onblur="input_check(this)"  autocomplete = 'off'>
		</div>
	</div>
	<div class="row cl" style="margin-bottom:15px;margin-right:25px;">
		<label class="form-label col-xs-4 col-sm-3" style="text-align:right;">路由(route)：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" name="link_url" value="" class="input-text"  autocomplete = 'off'>
		</div>
	</div>
	<div class="row cl" style="margin-bottom:15px;margin-right:25px;">
	...
	<div class="row cl">
		<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
            <input class="btn btn-primary radius" type="button"  onclick="menu_submit('/admin/menu/insert')" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
